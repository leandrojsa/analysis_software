...
Gem::Specification.new do |s|
  ...
  s.extensions = ["ext/json/ext/extconf_generator.rb", "ext/json/ext/extconf_parser.rb"]
  s.extra_rdoc_files = ["README"]
  s.files = ["bin/edit_json.rb", "bin/prettify_json.rb", "README", "ext/json/ext/extconf_generator.rb", "ext/json/ext/extconf_parser.rb"]
